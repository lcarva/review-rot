...
# Note: tests_require and test_suite are deprecated
# Use setup.cfg or pyproject.toml for test configuration instead
try:
...
setup(
    name="review-rot",
    version="1.0",
    author=("Maximilian Kosiarcik, Nirzari Iyer, Pavlina Bortlova, Sid Premkumar"),
    author_email=(
        "mkosiarc@redhat.com, niyer@redhat.com, "
        "pbortlov@redhat.com, sid.premkumar@gmail.com"
    ),
    description=(
        "CLI tool to list review(pull) requests from "
